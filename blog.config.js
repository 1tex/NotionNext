...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'a0e1279790424f64a827cef6aa42183b',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '赵天宇', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '微信:1521881635', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tyzhao.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'ty.zhao@live.com', // 邮箱
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/1tex', // 你的github个人主页
  ...
  // giscus @see https://giscus.app/z
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || '1tex/GiscusCache', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOIZ-18Q', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOIZ-18c4CSeJZ', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
