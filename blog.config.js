...
const BLOG = {
  ...
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'a0e1279790424f64a827cef6aa42183b', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:'', 合并冲突更正
  CONTACT_EMAIL: 'ty.zhao@live.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/1tex',
  CONTACT_TELEGRAM: '',
